<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="container m-auto py-4 px-4">
        <div class="flex justify-between">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="/owner">
                            ダッシュボード
                        </x-dropdown-link>

                        <x-dropdown-link href="/owner/shop">
                            ショップ一覧
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        {{--  <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('owner.index')" :active="request()->routeIs('owner.index')">
                {{ __('Owner') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link href="/owner">
                    ダッシュボード
                </x-responsive-nav-link>

                <x-responsive-nav-link href="/owner/shop">
                    ショップ一覧
                </x-responsive-nav-link>
