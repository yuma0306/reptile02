<form action="/pet" method="get" class="relative flex w-full">
    <input type="text" name="keyword" id="keyword" placeholder="{{ $slot }}" class="w-full border-teal-600 rounded focus:ring-teal-600 text-sm md:text-base">
