...
<form action="{{ $action }}" method="get" class="relative flex w-full max-w-[400px] h-14 overflow-hidden">
    ...
    <button type="submit" class="grid place-content-center w-14 h-full absolute top-0 right-0 bg-teal-600 border-teal-600 rounded-e">
